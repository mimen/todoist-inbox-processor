...
function PriorityOverlay({ currentPriority, onPrioritySelect, onClose, isVisible }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PriorityOverlay.useEffect": ()=>{
            ...
            const handleKeyUp = {
                "PriorityOverlay.useEffect.handleKeyUp": (e)=>{
                    if (e.key === 'p' || e.key === 'P') {
                        onClose();
                    }
                }
            }["PriorityOverlay.useEffect.handleKeyUp"];
...
;
;
function ProjectSelectionOverlay({ projects, currentProjectId, currentTask, projectHierarchy, onProjectSelect, onClose, isVisible }) {
    _s();
    const [searchTerm, setSearchTerm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    // Load suggestions
    const loadSuggestions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ProjectSelectionOverlay.useCallback[loadSuggestions]": async ()=>{
            if (!currentTask || !projectHierarchy || !isVisible) return;
            // Clear any existing suggestions first
            setSuggestions([]);
            setLoadingSuggestions(true);
            try {
                const aiSuggestions = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$suggestions$2d$cache$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["suggestionsCache"].generateSuggestions(currentTask.id, currentTask.content, currentTask.description || '', projectHierarchy, currentTask.projectId);
                console.log(`ProjectSelectionOverlay: Got suggestions for task ${currentTask.id}:`, aiSuggestions);
                // Filter out inbox suggestions
                const filteredSuggestions = aiSuggestions.filter({
                    "ProjectSelectionOverlay.useCallback[loadSuggestions].filteredSuggestions": (s)=>{
                        const project = projects.find({
                            "ProjectSelectionOverlay.useCallback[loadSuggestions].filteredSuggestions.project": (p)=>p.id === s.projectId
                        }["ProjectSelectionOverlay.useCallback[loadSuggestions].filteredSuggestions.project"]);
                        return project && !project.isInboxProject;
                    }
                }["ProjectSelectionOverlay.useCallback[loadSuggestions].filteredSuggestions"]);
                console.log(`ProjectSelectionOverlay: Setting filtered suggestions for task ${currentTask.id}:`, filteredSuggestions);
    ...
    }["ProjectSelectionOverlay.useCallback[loadSuggestions]"], [
        currentTask,
        projectHierarchy,
        isVisible,
        projects
    ...
    const buildProjectHierarchy = ()=>{
        ...
        // Add suggested projects at the top if no search term
        ...
        const addProjectWithChildren = (project, level)=>{
            if (project.name.toLowerCase().includes(searchTerm.toLowerCase())) {
                ...
                const isAlsoSuggested = !searchTerm && suggestedIds.has(project.id);
                result.push({
                    ...project,
                    level,
                    isAlsoSuggested
    ...
    // Clear suggestions when task changes
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProjectSelectionOverlay.useEffect": ()=>{
            setSuggestions([]);
        }
...
_s(ProjectSelectionOverlay, "Fm5weofLT0N7MqszHFI3Ccczz78=");
...
;
;
function ProjectSuggestions({ task, projects, projectHierarchy, onProjectSelect }) {
    _s();
    const [suggestions, setSuggestions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const loadSuggestions = async ()=>{
        if (!task || !projectHierarchy) return;
        setLoading(true);
        try {
            const suggestions = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$suggestions$2d$cache$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["suggestionsCache"].generateSuggestions(task.id, task.content, task.description || '', projectHierarchy, task.projectId);
            console.log('ProjectSuggestions: Loaded suggestions:', suggestions);
    ...
    const refreshSuggestions = async ()=>{
        if (!task || !projectHierarchy) return;
        // Invalidate cache for this task and regenerate
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$suggestions$2d$cache$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["suggestionsCache"].invalidateTask(task.id);
        await loadSuggestions();
    };
    // Load suggestions when task changes
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProjectSuggestions.useEffect": ()=>{
            loadSuggestions();
        }
    }["ProjectSuggestions.useEffect"], [
        task.id,
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        className: "text-sm text-gray-600",
                        children: "Generating project suggestions..."
                    }, void 0, false, {
                        fileName: "[project]/components/ProjectSuggestions.tsx",
                        lineNumber: 99,
                        columnNumber: 11
    ...
    if (!suggestions.length && !loading) {
        console.log('ProjectSuggestions: No suggestions, showing debug info');
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: "Debug: No project suggestions"
                    }, void 0, false, {
                        fileName: "[project]/components/ProjectSuggestions.tsx",
                        lineNumber: 110,
                        columnNumber: 11
...
_s(ProjectSuggestions, "SJrm5gSzMLQie88Z8vmnD8uOFSE=");
...
_s(TaskProcessor, "tA66mJFSmasYi8okjF76PApjX8E=");
_c = TaskProcessor;
var _c;
...
//# sourceMappingURL=_5b26b1cb._.js.map