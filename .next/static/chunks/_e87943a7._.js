...
function ProjectCard({ project, nestingDepth = 0, onDescriptionChange }) {
    ...
    const debouncedSave = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ProjectCard.useCallback[debouncedSave]": (value)=>{
            if (saveTimeout) {
                clearTimeout(saveTimeout);
            }
            const timeout = setTimeout({
                "ProjectCard.useCallback[debouncedSave].timeout": ()=>{
                    if (value !== project.description && onDescriptionChange) {
                        onDescriptionChange(project.id, value);
                    }
                }
            }["ProjectCard.useCallback[debouncedSave].timeout"], 1000);
            setSaveTimeout(timeout);
        }
    }["ProjectCard.useCallback[debouncedSave]"], [
        saveTimeout,
        project.description,
        project.id,
        onDescriptionChange
    ...
    const generateSuggestion = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ProjectCard.useCallback[generateSuggestion]": async ()=>{
    ...
    }["ProjectCard.useCallback[generateSuggestion]"], [
        project.id,
        description,
        debouncedSave,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProjectCard.useEffect": ()=>{
            const adjustHeight = {
                "ProjectCard.useEffect.adjustHeight": ()=>{
...
_s(ProjectCard, "eGhpgjjgDUePC4YmYwNzp3Nv5GY=");
_c = ProjectCard;
var _c;
...
function ProjectsPage() {
    ...
    const handleDescriptionChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ProjectsPage.useCallback[handleDescriptionChange]": async (projectId, newDescription)=>{
            try {
                ...
                // Update local state
                setProjects({
                    "ProjectsPage.useCallback[handleDescriptionChange]": (prev)=>prev.map({
                            "ProjectsPage.useCallback[handleDescriptionChange]": (project)=>project.id === projectId ? {
                                    ...project,
                                    description: newDescription
                                } : project
                        }["ProjectsPage.useCallback[handleDescriptionChange]"])
                }["ProjectsPage.useCallback[handleDescriptionChange]"]);
...
_s(ProjectsPage, "qpxWa0IuZlphrI2gXQqjky+9dp0=");
_c = ProjectsPage;
var _c;
...
//# sourceMappingURL=_e87943a7._.js.map