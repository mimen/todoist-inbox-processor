...
function ProjectSelectionOverlay({ projects, currentProjectId, currentTask, projectHierarchy, onProjectSelect, onClose, isVisible }) {
    ...
    // Load suggestions
    const loadSuggestions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        if (!currentTask || !projectHierarchy || !isVisible) return;
        // Clear any existing suggestions first
        setSuggestions([]);
        setLoadingSuggestions(true);
        try {
            const aiSuggestions = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$suggestions$2d$cache$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["suggestionsCache"].generateSuggestions(currentTask.id, currentTask.content, currentTask.description || '', projectHierarchy, currentTask.projectId);
...
function ProjectSuggestions({ task, projects, projectHierarchy, onProjectSelect }) {
    ...
    const loadSuggestions = async ()=>{
        ...
        setLoading(true);
        try {
            const suggestions = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$suggestions$2d$cache$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["suggestionsCache"].generateSuggestions(task.id, task.content, task.description || '', projectHierarchy, task.projectId);
    ...
    const refreshSuggestions = async ()=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$suggestions$2d$cache$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["suggestionsCache"].invalidateTask(task.id);
    ...
    const loadProjectTasks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (projectId)=>{
        ...
        try {
            ...
            if (tasksData.length > 0 && projectHierarchy) {
                try {
                    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$suggestions$2d$cache$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["suggestionsCache"].prefetchSuggestions(tasksData, projectHierarchy);
                } catch (error) {
...
//# sourceMappingURL=_ac3d9f48._.js.map