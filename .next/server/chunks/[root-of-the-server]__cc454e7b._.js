...
"[project]/.next-internal/server/app/api/projects/[projectId]/suggest-description/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
class TodoistApiClient {
    ...
    static async moveTaskToProject(taskId, projectId) {
        try {
            console.log('🔄 Moving task via Sync API:', {
                taskId,
                projectId
            });
...
"[project]/app/api/projects/[projectId]/suggest-description/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(request, { params }) {
    try {
        ...
        const [projects, tasks] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$todoist$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TodoistApiClient"].getProjects(),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$todoist$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TodoistApiClient"].getProjectTasks(params.projectId)
        ]);
        ...
        const taskList = tasks.filter((task)=>!task.content.startsWith('* ')) // Exclude description tasks
        .slice(0, 10) // Limit to first 10 tasks
        .map((task)=>`• ${task.content}`).join('\n');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cc454e7b._.js.map