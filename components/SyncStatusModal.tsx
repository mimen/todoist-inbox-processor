                  ...
                  {loading ? (
                    ...
                    <table className="w-full text-sm">
                      <thead className="bg-gray-50 border-b border-gray-200">
                        <tr>
                          <th className="text-left px-3 py-2 font-medium text-gray-700">Calendar</th>
                          <th className="text-center px-3 py-2 font-medium text-gray-700">Events</th>
                          <th className="text-left px-3 py-2 font-medium text-gray-700">Last Sync</th>
                          <th className="text-left px-3 py-2 font-medium text-gray-700">Sync Token</th>
                        ...
                        {calendars.map((calendar) => (
                          <tr key={calendar.calendarId} className="hover:bg-gray-50 transition-colors">
                            <td className="px-3 py-2">
                              <div className="flex items-center gap-2">
                                ...
                                <div className="min-w-0">
                                  <div className="font-medium text-gray-900 truncate" title={calendar.calendarName}>
                            ...
                            <td className="px-3 py-2 text-center">
                              <span className="inline-flex items-center justify-center min-w-[2.5rem] px-2 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
                                {calendar.eventCount}
                              </span>
                            </td>
                            <td className="px-3 py-2">
                              <div className="text-gray-900">{formatDate(calendar.lastSync)}</div>
